...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        private readonly SignInManager<SysAppusers> _signInManager;
        ...
        public ExternalController(
            ...
            SignInManager<SysAppusers> signInManager,
        ...
        private async Task<(SysAppusers user, string provider, string providerUserId, IEnumerable<Claim> claims)>
